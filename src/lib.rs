...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ServiceMesh processing");
    
    let mut processor = ServiceMeshProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ServiceMeshProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ServiceMeshProcessor::new(false);
